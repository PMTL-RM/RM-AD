...
import com.so2.running.Fragment.JoinedTeamListItem;
import com.so2.running.R;

import java.util.ArrayList;
import java.util.List;

public class JoinedTeamListAdapter extends ArrayAdapter<JoinedTeamListItem> {
    private LayoutInflater mInflater;
    private ArrayList<JoinedTeamListItem> sessionList;

    public JoinedTeamListAdapter(Context context, int resource, List<JoinedTeamListItem> objects) {
    ...
    @Override
    public JoinedTeamListItem getItem(int arg0) {
